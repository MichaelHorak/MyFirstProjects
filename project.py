...
class Question2(Question):
    def __init__(self, genre):
        ...
        while len(self.answer_pool) < 4:
            self.artist2, self.album2, self.song2, self.date2 = super().get_line_from_db()
            # check for duplicate data
            if self.album2 not in self.answer_pool:
...
class Question4(Question):
    def __init__(self, genre):
        ...
        while len(self.answer_pool) < 4:
            self.artist2, self.album2, self.song2, self.date2 = super().get_line_from_db()
            # check for duplicate data
            if self.date2 not in self.answer_pool:
...
def generate_questions(genre, score):
    ...
    print(last_question)
    last_question.answers_input(score)
    results_interpretation(score)


def results_interpretation(score):
    final_score = score.get_score()
    if final_score == 0:
        print(f"Your final score is {final_score}/10: Don't worry, everyone starts somewhere. Keep exploring and "
              f"you'll become a music maestro!")
    elif final_score == 1:
        print(f"Your final score is {final_score}/10: A good effort! Music knowledge is a journey, and you're on the "
              f"right track.")
    elif final_score == 2:
        print(f"Your final score is {final_score}/10: Nice try! You're getting the hang of it. Keep listening and "
              f"learning.")
    elif final_score == 3:
        print(f"Your final score is {final_score}/10: Not bad at all! You've got a good foundation. Keep up the great "
              f"work!")
    elif final_score == 4:
        print(f"Your final score is {final_score}/10: You're halfway there! Your music knowledge is growing. Keep it "
              f"up!")
    elif final_score == 5:
        print(f"Your final score is {final_score}/10: Impressive! You're really starting to know your stuff. Keep the "
              f"momentum going!")
    elif final_score == 6:
        print(f"Your final score is {final_score}/10: Well done! You have a solid grasp of music. Keep exploring new "
              f"genres and artists.")
    elif final_score == 7:
        print(f"Your final score is {final_score}/10: Fantastic job! You're on your way to becoming a music expert. "
              f"Keep up the great work!")
    elif final_score == 8:
        print(f"Your final score is {final_score}/10: Incredible! You have an impressive knowledge of music. Keep "
              f"expanding your horizons.")
    elif final_score == 9:
        print(f"Your final score is {final_score}/10: Amazing! You're a true music connoisseur. Keep exploring and "
              f"enjoying the world of music.")
    elif final_score == 10:
        print(f"Your final score is {final_score}/10: Perfect score! You're a music virtuoso. Your knowledge is truly "
              f"exceptional!")
    else:
